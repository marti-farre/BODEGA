...
> Misinformation Detection"* (Anonymous Author, Anonymous Author; under review at EMNLP 2026).
...
[`ANONYMOUS/xarello`](https://github.com/ANONYMOUS/xarello) repo under
...
(this paper uses the [`ANONYMOUS/BODEGA`](https://github.com/ANONYMOUS/BODEGA)
fork, which adds the static defence library MACABEU selects over) and uses
[`ANONYMOUS/xarello`](https://github.com/ANONYMOUS/xarello) as the adaptive
attacker.
...
1. Clone all three repos as siblings (the paper's fork of BODEGA + XARELLO):
   ```bash
   git clone https://github.com/ANONYMOUS/BODEGA.git
   git clone https://github.com/ANONYMOUS/macabeu.git
   git clone https://github.com/ANONYMOUS/xarello.git   # optional, only for XARELLO eval
   ```
...
by [`paper_assets/`](https://github.com/ANONYMOUS/BODEGA/tree/main/paper_assets)
in the BODEGA fork.
...
- **BODEGA**: [Verifying the Robustness of Automatic Credibility Assessment](https://doi.org/10.1017/nlp.2024.54) (NLP Journal). This repo uses the [`ANONYMOUS/BODEGA`](https://github.com/ANONYMOUS/BODEGA) fork that adds the static defence library.
- **XARELLO**: [Know Thine Enemy: Adaptive Attacks on Misinformation Detection Using Reinforcement Learning](https://aclanthology.org/2024.wassa-1.11/) (WASSA @ ACL 2024). Implementation at [`ANONYMOUS/xarello`](https://github.com/ANONYMOUS/xarello).
- Developed within the the ANONYMOUS PROJECT project at the the ANONYMOUS LAB, ANONYMOUS INSTITUTION.
