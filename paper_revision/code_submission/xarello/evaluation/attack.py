...
parser.add_argument('--label_source', type=str, default='oracle',
                    choices=['oracle', 'mv7'],
                    help='Label source for online reward: oracle (gold, unrealistic) '
                         'or mv7 (MajorityVote-7 pseudo-label, deployment-realistic).')
parser.add_argument('--reward_mode', type=str, default='hard',
                    choices=['hard', 'soft'],
                    help='Reward magnitude: hard=±1, soft=±p (winning vote fraction). '
                         'Only relevant when --label_source=mv7.')
